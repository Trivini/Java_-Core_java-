...
public class Student extends AbstractPerson implements Payable, Personable {
    ...
    public void calculatePayment(){
        ...
        System.out.println("Paymentb processing :");
        System.out.println("Select one of the Payment Option below");
        ...
        if (option == 1) {
            ...
            System.out.println("Paying Fee: "+(finalFees-gd));
            processor.makePayment((finalFees-gd), bankName.getBankName());
        }
        else if (option == 2) {
            System.out.println("Do for Card Payment");
            CardPayment cardpayment = new CardPayment();
            cardpayment.setCardNumber(cardpayment.getCardNumber());
            processor.makePayment((finalFees-gd), cardpayment.getCardNumber());
        }

        else if (option == 3) {
            System.out.println("Do for UPI Payment");
            UpiPayment upiPayment = new UpiPayment();
            upiPayment.setUpiId((upiPayment.getUpiId()));
            processor.makePayment((finalFees-gd), upiPayment.getUpiId());

            upiPayment.setUpiType((upiPayment.getUpiType()));
            processor.makePayment((finalFees-gd), upiPayment.getUpiType());
